 ...
 *
 * @see PersonValueImpl.Builder
 */
public class PersonValueImpl implements PersonValue {
    public static class Builder implements PersonValue {
        ...
        /**
         * Construct a copy of the specified {@link PersonValue}
         */
        public Builder(PersonValue copy) {
        ...
        public PersonValueImpl build() {
            return new PersonValueImpl(this);
        }
    }
    ...
    protected PersonValueImpl(Builder builder) {
