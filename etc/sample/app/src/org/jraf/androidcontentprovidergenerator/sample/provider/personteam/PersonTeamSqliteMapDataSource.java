 ...
 */
public class PersonTeamSqliteMapDataSource extends AbstractSqliteMapDataSource<PersonTeamKey, PersonTeamValue, PersonTeamCursor, PersonTeamSelection> {
    /**
     * Contructor.
     *
     * <p>Uses a {@link org.jraf.androidcontentprovidergenerator.sample.provider.personteam.PersonTeamMapDatabaseModelHandler} to read/write data in the database.</p>
     *
     ...
     */
    public PersonTeamSqliteMapDataSource(@NonNull Context context) {
        this(context, PersonTeamMapDatabaseSerializer.INSTANCE);
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public PersonTeamSqliteMapDataSource(@NonNull Context context, MapDatabaseSerializer<PersonTeamKey, PersonTeamValue, PersonTeamCursor> serializer) {
        this(context, new PersonTeamMapDatabaseModelHandler(serializer));
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public PersonTeamSqliteMapDataSource(@NonNull Context context, @NonNull MapDatabaseModelHandler<PersonTeamKey, PersonTeamValue, PersonTeamCursor, PersonTeamSelection> databaseModelHandler) {
    ...
    public <MODEL extends PersonTeamKey & PersonTeamValue> Long insert(MODEL value) {
        return insert(value, value);
    }

    public <MODEL extends PersonTeamKey & PersonTeamValue> boolean update(MODEL value) {
