...
/**
 * Helper class to post read/write tasks for the {@code product} table.
 */
public class ProductAsyncHandler extends TypedAsyncDatabaseHandler<ProductModel, ProductCursor, Long, Uri> {
    /**
     * Constructor.
     *
