 ...
 *
 * @see PersonTeamImpl.Builder
 */
public class PersonTeamImpl extends PersonTeamKeyImpl implements PersonTeamModel {
    public static class Builder extends PersonTeamKeyImpl.Builder implements PersonTeamModel {
        ...
        public PersonTeamImpl build() {
            return new PersonTeamImpl(this);
        }
    }
    ...
    protected PersonTeamImpl(Builder builder) {
        super(builder);
