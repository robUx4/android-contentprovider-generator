 ...
 * A serial number.
 *
 * @see SerialNumberValueImpl.Builder
 */
public class SerialNumberValueImpl implements SerialNumberValue {
    public static class Builder implements SerialNumberValue {
        ...
        /**
         * Construct a copy of the specified {@link SerialNumberValue}
         */
        public Builder(SerialNumberValue copy) {
        ...
        public SerialNumberValueImpl build() {
            return new SerialNumberValueImpl(this);
        }
    }
    ...
    protected SerialNumberValueImpl(Builder builder) {
