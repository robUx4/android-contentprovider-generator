 ...
 *
 * @see TeamImpl.Builder
 */
public class TeamImpl extends TeamKeyImpl implements TeamModel {
    public static class Builder extends TeamKeyImpl.Builder implements TeamModel {
    ...
    protected TeamImpl(Builder builder) {
        super(builder);
