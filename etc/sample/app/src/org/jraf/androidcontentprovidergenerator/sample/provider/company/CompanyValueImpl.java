 ...
 *
 * @see CompanyValueImpl.Builder
 */
public class CompanyValueImpl implements CompanyValue {
    public static class Builder implements CompanyValue {
        private String name;
        ...
        /**
         * Construct a copy of the specified {@link CompanyValue}
         */
        public Builder(CompanyValue copy) {
        ...
        public CompanyValueImpl build() {
            return new CompanyValueImpl(this);
        }
    }
    ...
    protected CompanyValueImpl(Builder builder) {
