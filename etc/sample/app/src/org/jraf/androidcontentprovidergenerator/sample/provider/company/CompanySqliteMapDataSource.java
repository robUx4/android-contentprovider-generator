 ...
 */
public class CompanySqliteMapDataSource extends AbstractSqliteMapDataSource<CompanyKey, CompanyValue, CompanyCursor, CompanySelection> {
    /**
     * Contructor.
     *
     * <p>Uses a {@link org.jraf.androidcontentprovidergenerator.sample.provider.company.CompanyMapDatabaseModelHandler} to read/write data in the database.</p>
     *
     ...
     */
    public CompanySqliteMapDataSource(@NonNull Context context) {
        this(context, CompanyMapDatabaseSerializer.INSTANCE);
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public CompanySqliteMapDataSource(@NonNull Context context, MapDatabaseSerializer<CompanyKey, CompanyValue, CompanyCursor> serializer) {
        this(context, new CompanyMapDatabaseModelHandler(serializer));
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public CompanySqliteMapDataSource(@NonNull Context context, @NonNull MapDatabaseModelHandler<CompanyKey, CompanyValue, CompanyCursor, CompanySelection> databaseModelHandler) {
    ...
    public <MODEL extends CompanyKey & CompanyValue> Long insert(MODEL value) {
        return insert(value, value);
    }

    public <MODEL extends CompanyKey & CompanyValue> boolean update(MODEL value) {
