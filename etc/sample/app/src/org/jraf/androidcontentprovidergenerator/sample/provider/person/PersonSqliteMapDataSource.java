 ...
 */
public class PersonSqliteMapDataSource extends AbstractSqliteMapDataSource<PersonKey, PersonValue, PersonCursor, PersonSelection> {
    /**
     * Contructor.
     *
     * <p>Uses a {@link org.jraf.androidcontentprovidergenerator.sample.provider.person.PersonMapDatabaseModelHandler} to read/write data in the database.</p>
     *
     ...
     */
    public PersonSqliteMapDataSource(@NonNull Context context) {
        this(context, PersonMapDatabaseSerializer.INSTANCE);
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public PersonSqliteMapDataSource(@NonNull Context context, MapDatabaseSerializer<PersonKey, PersonValue, PersonCursor> serializer) {
        this(context, new PersonMapDatabaseModelHandler(serializer));
    }
     ...
     * @param context Context used to get the {@link android.database.sqlite.SQLiteOpenHelper SQLiteOpenHelper} used to access the data
     */
    public PersonSqliteMapDataSource(@NonNull Context context, @NonNull MapDatabaseModelHandler<PersonKey, PersonValue, PersonCursor, PersonSelection> databaseModelHandler) {
    ...
    public <MODEL extends PersonKey & PersonValue> Long insert(MODEL value) {
        return insert(value, value);
    }

    public <MODEL extends PersonKey & PersonValue> boolean update(MODEL value) {
