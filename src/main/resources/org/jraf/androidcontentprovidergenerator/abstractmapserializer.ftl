 ...
 */
public final class ${entity.nameCamelCase}MapDatabaseSerializer implements MapDatabaseSerializer<${entity.nameCamelCase}Key, ${entity.nameCamelCase}Value, ${entity.nameCamelCase}Cursor> {
