 ...
 *
 */
public class SqliteSourceOutput extends DataSourceOutput {

	@Override
	public int hashCode() {
		return SqliteSourceOutput.class.hashCode();
	}
	...
	public void generateOutput(Configuration freeMarkerConfig, Arguments arguments, JSONObject config, Entity entity) throws IOException, JSONException, TemplateException {
        ...
        template = freeMarkerConfig.getTemplate("databaseserializer.ftl");
        ...
        template = freeMarkerConfig.getTemplate("sqldatasource.ftl");
        outputFile = new File(outputDir, entity.getNameCamelCase() + "SqliteDataSource.java");
        DataSourceOutput.writeOutput(template, outputFile, root);
